...
# Migrates the tree
ldapadd -D "cn=admin,dc=federez,dc=net" -W -H ldapi:/// ./migrations/dit/organizational_units.ldif
...
ldapmodify -D "cn=admin,dc=federez,dc=net" -W -H ldapi:/// ./migrations/overlays/ppolicy_policies.ldif
